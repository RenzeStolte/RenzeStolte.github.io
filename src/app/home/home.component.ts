...
const STORMCAST_ARMY: Army = {
  ...
  units: [
      ...
      actions: [
        ...
        },
        {
          ...
          actionDetails: {
            ...
            effect: 'That objective is considered questmarked by you.',
          },
    ...
    },
    {
      ...
      actions: [
        ...
        },
        {
          ...
          actionDetails: {
            actionType: 'passive',
            effect: 'Subtract 1 from casting rolls and chanting rolls for enemy units within 12" while this unit\'s Gryph-crow is on the battlefield. On an unmodified save of 1, remove the Gryph-crow after the Attack ability resolves.',
          },
          phaseActivation: BattlePhase.HERO,
          phaseActivationTiming: 'opponent',
          numberOfTimes: 'unlimited',
    ...
    },
    {
      ...
      actions: [
        ...
        },
        {
          ...
          actionDetails: {
            actionType: 'passive',
            effect: 'Add 3 to the control scores of friendly Ruination Chamber units within 12" while this unit\'s Memorian is on the battlefield. On an unmodified save of 1, remove the Memorian after the Attack ability resolves.',
          },
          phaseActivation: BattlePhase.START,
          phaseActivationTiming: 'any',
          numberOfTimes: 'unlimited',
        },
        {
          ...
          actionDetails: {
            actionType: 'activated',
            declare: 'Reaction: You declared a Fight ability for this unit. Pick a friendly non-Hero Ruination Chamber Infantry unit within combat range that has not used a Fight ability this turn.',
            effect: 'That unit can use a Fight ability immediately after this unit\'s Fight resolves. If it does so, add 1 to hit rolls for that unit for the rest of the turn.',
          },
          phaseActivation: BattlePhase.ATTACK,
          phaseActivationTiming: 'own',
          numberOfTimes: 'unlimited',
      ...
      actions: [
        ...
        },
        {
          ...
          actionDetails: {
            ...
            effect: 'That unit can use 2 Fight abilities this phase. After the first, that unit has Strike-last for the rest of the turn.',
          },
          phaseActivation: BattlePhase.ATTACK,
          phaseActivationTiming: 'own',
          numberOfTimes: 'once',
    ...
    {
      name: 'Liberators',
      keywords: ['Battleline', 'Infantry', 'Champion', 'Order', 'Stormcast Eternals', 'Warrior Chamber'],
      characteristics: { move: '5"', save: '3+', health: '2', control: '1' },
      weapons: [
        {
          name: 'Warhammer or Warblade',
          type: 'melee',
          attacks: '2',
          hit: '3+',
          wound: '3+',
